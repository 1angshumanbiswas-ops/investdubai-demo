        ...
        <div className="p-5 flex flex-col flex-1 gap-4">
          ...
          <div className="bg-cream rounded-xl px-4 py-3">
            ...
            {property.startingPrice > 0 ? (
              ...
              <p className="text-2xl font-bold text-navy">Price on Request</p>
            )}
          </div>
...
function PropertiesPageInner() {
  ...
  const filtered = PROPERTIES
    ...
    .sort((a, b) => {
      // Price-on-Request listings (startingPrice === 0) always sort last, regardless of direction
      if (a.startingPrice === 0 && b.startingPrice !== 0) return 1
      if (b.startingPrice === 0 && a.startingPrice !== 0) return -1
