...
export const PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    // REAL pricing — taken from a live "Available Units" inventory sheet (14 units, Towers 1-3)
    // supplied directly by Shylesh, not a brochure estimate. startingPrice is the lowest confirmed
    // unit on that sheet (III-709, 1BR). Full range across the 14 available units: AED 2,439,828
    // (1BR) to AED 5,403,828 (3BR). See description for the per-bedroom breakdown.
    startingPrice: 2_439_828,
    // Real payment plan — taken directly from the official Project Brief PDF.
    // NOTE: the milestones as printed sum to 95%, not 100% (20+10+10+5+5+5+5+5+5+30).
    // Flagging for Angshuman/Shylesh to confirm the real final milestone (likely 35% on completion)
    // before this goes live — not corrected here since it's unverified which figure is wrong.
    paymentPlan: '20% at booking, 10% at 60 days, 10% at 120 days, 5% at 240 days, 5% at 360 days, then 5% x 4 on completion of 20/30/40/50% construction, 30% on completion (per brief — milestones total 95%, pending confirmation).',
    // Real — "Completion Date" stated directly in the official Project Brief PDF.
    handoverDate: 'Q4 2029',
    unitTypes: ['Studio', '1BR', '2BR', '3BR', 'Penthouse'],
    goldenVisaEligible: 'check',
    brochureUrl: '/brochures/portside-square-brief.pdf',
    // ROI UNCONFIRMED — no rental yield/ROI figure appears anywhere in the Project Brief PDF.
    // Placeholder pending real data from Shylesh/Ellington, same flagging pattern as IDs 21/23/24.
    roiEstimate: 6.0,
    status: 'Off-Plan',
    image: '/images/properties/portside-square-hero-towers-twilight.jpg',
    gallery: [
      '/images/properties/portside-square-hero-towers-twilight.jpg',
      '/images/properties/portside-square-waterfront-landmark-dusk.jpg',
      '/images/properties/portside-square-mina-rashid-heritage.jpg',
      '/images/properties/portside-square-architecture-close-up.jpg',
      '/images/properties/portside-square-pool-deck-dusk.jpg',
    ],
    featured: true,
    description: "Portside Square is Ellington Properties' newest waterfront landmark in Dubai's historic Mina Rashid — three sculptural residential towers (Portside Residences I, II, III) totalling 408 units from Studio to 4-Bedroom Penthouse, freehold, with an anticipated completion of Q4 2029 and anticipated service charge of AED 17 per sq ft. 14 units currently available across Towers 1-3: 1-Bedroom from AED 2.44M–2.64M, 2-Bedroom from AED 3.60M–4.46M, and 3-Bedroom at AED 5.40M. Residents get direct access to a three-floor amenities pavilion with a wellness spa, fitness studio, and rooftop clubhouse, plus panoramic views of the Arabian Gulf, Downtown Dubai, and the marina promenade.",
    amenities: [
      'Outdoor Yoga & Garden Area',
      'Pool Deck',
      'Co-Working Pods & Lounge Seating',
      'Male & Female Spa (Sauna, Steam, Aromatherapy)',
      'Hot & Cold Plunge Pools',
      'Aqua Cycling',
      'Pilates & Yoga Studio',
      'Kids Play Area & Nursing Room',
      'Free Weights & Strength Training Zone',
      'Cable Station & TRX Suspension Training',
      'Cardio & Circuit Stations',
      'Juice Bar',
      'Clubhouse Lounge & Dining',
      'Shuffleboard & Games Table',
      'Clubhouse Show Bar',
    ],
  },
  {
  ...
  },
  {
    id: '38',
    developerName: 'Emaar',
    projectName: 'Valia — Dubai Creek Harbour',
    location: 'Dubai Creek Harbour, Dubai',
    startingPrice: 1_960_000,
    paymentPlan: '10% booking · 7×10% during construction · 20% on handover (Dec 2030)',
    ...
    roiEstimate: 7.0,
    status: 'Off-Plan',
    image: '/images/properties/valia-hero.jpg',
    gallery: [
      '/images/properties/valia-hero.jpg',
      '/images/properties/valia-community.jpg',
      '/images/properties/valia-pool.jpg',
      '/images/properties/valia-yoga.jpg',
      '/images/properties/valia-interior.jpg',
    ],
    videoUrl: 'https://www.youtube.com/embed/j1SW_eMN26A',
    featured: true,
    beds: '1–4',
    sqft: '817–2,561 sq.ft.',
    description: "Valia is Emaar's latest landmark at Dubai Creek Harbour — a high-rise mixed-use tower offering 491 residences (1 to 4 bedrooms) with panoramic views of the Burj Khalifa, Dubai Creek waterfront, and the iconic cityscape. Rising from a vibrant mixed-use podium with retail and dining, Valia is architecturally designed with high-window glazing, sleek aluminium cladding, and every unit featuring a dedicated balcony. The upcoming Blue Line Metro station places the full breadth of Dubai within easy reach. 10 minutes to Dubai International Airport, 15 minutes to Burj Khalifa and Downtown Dubai, 25 minutes to Dubai Marina.",
    amenities: [
      ...
      'BBQ Area',
      'Private Cabanas',
      'Grand High-Ceiling Lobby',
      'Concierge Services',
      'Blue Line Metro (upcoming)',
    ],
  },
  {
    id: '39',
    developerName: 'Emaar',
    projectName: 'Greencrest',
    location: 'Dubai Hills Estate, Dubai',
    startingPrice: 1_570_000,
    paymentPlan: '10% booking · 7×10% during construction · 20% on handover (Jun 2029)',
    handoverDate: 'Q2 2029',
    unitTypes: ['1BR', '2BR', '3BR'],
    goldenVisaEligible: 'check',
    brochureUrl: '/brochures/GREENCREST_DHE_BROCHURE.pdf',
    roiEstimate: 6.5, // ESTIMATE — no rental yield data in factsheet, confirm before publishing as final
    status: 'Off-Plan',
    image: '/images/properties/greencrest-hero.jpg',
    gallery: [
      '/images/properties/greencrest-hero.jpg',
      '/images/properties/greencrest-pool.jpg',
      '/images/properties/greencrest-lobby.jpg',
      '/images/properties/greencrest-community.jpg',
      '/images/properties/greencrest-kids-pool.jpg',
    ],
    videoUrl: 'https://www.youtube.com/embed/aozX0l9Bfbk',
    featured: true,
    beds: '1–3',
    sqft: '774–1,928 sq.ft.',
    description: "Greencrest is Emaar's 195-unit residential tower at Dubai Hills Estate — 'The Green Heart of Dubai' — offering one, two, and three-bedroom homes framed by rolling greens and panoramic views of the Dubai Hills Golf Club. The 11-million-square-metre master community weaves contemporary living into a lush green tapestry, with wellness-focused amenities including indoor and outdoor gyms, adult and kids' pools, a multi-purpose hall, and yoga decks. Seamless access: 10 minutes to Downtown Dubai, 10 minutes to Dubai Marina, 15 minutes to Dubai International Airport, 20 minutes to Al Maktoum International Airport.",
    amenities: [
      'Indoor Gym',
      'Outdoor Gym',
      'Adult Swimming Pool',
  ...
  },
  {
    id: '41',
    developerName: 'DAMAC',
    projectName: 'Chelsea Residences (Tower C) by DAMAC',
    location: 'Dubai Maritime City, Dubai',
    startingPrice: 2_560_000,
    paymentPlan: '15% down payment (incl. DLD waiver fee) · 0.25% monthly instalments with periodic 5–6% milestones through month 41 · 40% on completion',
    handoverDate: 'Q2 2030', // anticipated completion 30 June 2030, per payment plan footnote
    unitTypes: ['1BR', '2BR', '3BR'],
    goldenVisaEligible: true,
    brochureUrl: '/brochures/Chelsea_brochure.pdf',
    roiEstimate: 6.5, // ESTIMATE — no rental yield data in source materials, confirm before publishing as final
    status: 'Off-Plan',
    image: '/images/properties/chelsea-residences-hero.jpg',
    gallery: [
      '/images/properties/chelsea-residences-hero.jpg',
      '/images/properties/chelsea-residences-exterior.jpg',
      '/images/properties/chelsea-residences-pool.jpg',
      '/images/properties/chelsea-residences-pitch.jpg',
    ],
    videoUrl: 'https://www.youtube.com/embed/IZ1xYUfJQxw',
    featured: true,
    beds: '1–3',
    // sqft: UNCONFIRMED — not stated in source materials, confirm with DAMAC/Shylesh
    description: "Chelsea Residences by DAMAC is the world's first football-branded residences, developed in partnership with Chelsea Football Club at Dubai Maritime City. Tower C is the grand finale of Chelsea Residences — the final tower, shaped by every refinement that came before it, positioned at the most coveted point within the masterplan where panoramic sea views meet true seclusion. 1, 2 & 3-bedroom waterfront apartments with floor-to-ceiling living and uninterrupted 270° sea views. Bulk-buy discounts available for investors (1%–5% depending on volume, full-floor to 30+ units). 14 minutes to Jumeirah Beach, 15 minutes to Metro, 12 minutes to Dubai International Airport (DXB), 10 minutes to City Walk.",
    amenities: [
      'Lion Beach',
      'Blue Match Club',
      'Standard Gauge Rooftop Pitch',
      'Athlete Performance Training Centre',
  ...
  },
  {
    id: '42',
    developerName: 'DAMAC',
    projectName: 'Chelsea Residences 1 & 2',
    location: 'Dubai Maritime City, Dubai',
    startingPrice: 2_169_000,
    paymentPlan: '20% deposit (immediate) · 1% monthly instalments from month 3 to month 42 · 40% on completion',
    handoverDate: 'Q4 2029', // anticipated completion 31 December 2029, per official DAMAC payment plan
    unitTypes: ['1BR', '2BR', '3BR'],
    goldenVisaEligible: true,
    brochureUrl: '/brochures/Chelsea_brochure.pdf',
    roiEstimate: 6.5, // ESTIMATE — no rental yield data in source materials, confirm before publishing as final
    status: 'Off-Plan',
    image: '/images/properties/chelsea-residences-1-2-hero.jpg',
    gallery: [
      '/images/properties/chelsea-residences-1-2-hero.jpg',
      '/images/properties/chelsea-residences-1-2-aerial-dusk.jpg',
      '/images/properties/chelsea-residences-1-2-sunset.jpg',
      '/images/properties/chelsea-residences-night-show.jpg',
      '/images/properties/chelsea-residences-balcony-view.jpg',
    ],
    featured: true,
    beds: '1–3',
    sqft: '772–2,842 sq.ft.',
    description: "Chelsea Residences 1 & 2 by DAMAC span four waterfront towers (Tower A, Tower B, Tower 2A, Tower 2B) at Dubai Maritime City — part of the world's first football-branded residences, developed in partnership with Chelsea Football Club. 1, 2 & 3-bedroom contemporary apartments with floor-to-ceiling living and panoramic sea and skyline views, including direct views of the Burj Khalifa and Downtown Dubai from select units. Positioned alongside Tower C (the final and most exclusive release in the Chelsea Residences masterplan), Towers 1 & 2 offer the broadest unit selection across the development, from entry-level 1BR homes to expansive 3BR waterfront residences.",
    amenities: [
      ...
      'Oasis Bar',
      'Aqua Dining',
      'Mono Diet Cafe (Healthy Fine Dining)',
      'Sunken Pool Seating',
      'Tranquillity Falls',
      'Waterfall Sound Therapy',
      'Kids Pool',
      'Kids Garden',
      'Indoor Kids Play Area',
      'Coral Beach',
      'Snorkeling on Pool Swing on the Coral',
      'Kneipp Parkour',
      'Five Senses Grounding Path',
      'Jogging Track',
      'Water Treatment Tunnel',
      'Outdoor Gym & Yoga',
      'Aqua-Themed Gym',
      'Cryotherapy',
      'Forest Relaxation Pods',
      'Meditation Garden',
      'Sunken Gathering Garden',
      ...
      'Powerhouse Lounge',
      'Legends Walkway',
      'Stamford Cinema — The Pride Lounge',
