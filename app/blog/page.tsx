...
const PLACEHOLDER_ARTICLES: { title: string; category: string; excerpt: string; date: string; href?: string }[] = [
  ...
  { title: 'Dubai Property for Indian Investors — Tax, ROI, Golden Visa, Process', category: 'Country Guide', excerpt: 'A complete guide for NRIs and Indian investors — currency comparison, tax advantages, best communities, and how to buy Dubai property from India.', date: 'July 2026', href: '/blog/dubai-property-indian-investors-2026' },
  ...
  { title: 'How to Evaluate an Off-Plan Developer in Dubai', category: 'Developer Guide', excerpt: 'Not all developers are equal. Here\'s how to assess track record, RERA registration, delivery history, and financial strength before committing to an off-plan purchase.', date: 'July 2026', href: '/blog/evaluate-offplan-developer-dubai' },
]
